...
float(requests.get(f"http://ramcdougal.com/cgi-bin/error_function.py?a=0.4&b=0.2", headers={"User-Agent": "MyScript"}).text)
...
# %%
# 2 and -3. increased step size to ensure stepping far enough wouldnt lead up to another minimum
